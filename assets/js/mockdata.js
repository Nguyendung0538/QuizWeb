        ...
        questions: [
            {
                ...
                correctOption: 1,
                explanation: "ICMP thuộc Network Layer (Tầng mạng)."
            },
            {
                id: "m2",
                ...
                correctOption: 1,
                explanation: "Địa chỉ MAC (Physical Address) luôn dài 48 bit."
            },
            {
                id: "m3",
                ...
                correctOption: 1,
                explanation: "Standard Switch hoạt động ở tầng Data Link (Layer 2)."
            }
        ]
    },
    {
        ...
        questions: [
            {
                ...
                correctOption: 1,
                explanation: "DISTINCT dùng để lọc các giá trị duy nhất."
            },
            {
                id: "db2",
                ...
                correctOption: 2,
                explanation: "HAVING dùng để đặt điều kiện cho các nhóm (Groups)."
            }
        ]
    }
];

// Lệnh thực thi: Lưu vào LocalStorage
